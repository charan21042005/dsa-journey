...
* Exit a function
* Optionally send a value back to the caller

In `main()`, `return 0;` indicates **successful execution**.

![Flow of control with return Statement in C++](../Images/17.png)
...
```
### Example: Early Exit Using return
```cpp
#include <iostream>
using namespace std;
...
The `goto` statement allows unconditional jump to a labeled statement.

![Flowchart for goto Statement in C++](../Images/18.png)

⚠️ **Not recommended** in modern programming due to:
* Poor readability
* Difficult debugging
...
* Sometimes used in low-level or legacy code

### 🔹 Comparison of Jump Statements
| Statement  | Purpose                | Recommended |
| ---------- | ---------------------- | ----------- |
| `continue` | Skip current iteration | ✅ Yes       |
| `break`    | Exit loop/switch       | ✅ Yes       |
| `return`   | Exit function          | ✅ Yes       |
| `goto`     | Jump anywhere          | ❌ Avoid     |

### ✅ Summary
* Jump statements control program flow
* `continue` skips an iteration
* `break` exits loop or switch
* `return` exits a function and returns value
* `goto` provides unconditional jumps (avoid)

Jump statements are powerful tools, but they should be used **carefully and logically**
...
In C++ programming, there are many situations where we need to **execute a block of code multiple times**.

For example, if we want to print **"Hello World" 5 times**, writing the same `cout` statement again and again is inefficient and not scalable.

Loops help us:
- Reduce code repetition
- Improve readability
- Handle repetitive logic efficiently
- Solve almost every DSA problem

---

## 🔹 Example Without Loop (Not Recommended)
...
```
This **approach is bad practice**.
### 🔹 Example Using Loop (Recommended)
```cpp
#include <iostream>
using namespace std;
...
![Flowchart of for Loop in C++](../Images/19.png)
...
| Test Condition    | Checked before every iteration |
| Update Expression | Updates loop variable          |
...
![Flowchart of while Loop in C++](../Images/20.png)
...
![Flowchart of do-while Loop in C++](../Images/21.png)
...
## 4. Range-based `for-each` Loop (C++11)

The range-based for loop is used to iterate over:
* Arrays
* Vectors
* Containers

It internally uses `begin()` and `end()`.
...
int main() {
    ...
    for (auto it : arr) {
        it = it * 2;   // does NOT affect original array
    }
...
int main() {
    ...
    for (auto &it : arr) {
        it = it * 2;   // modifies original array
    }
...
⚠️ Infinite loops must always have a **break condition**.
...
* Range-based loop simplifies container traversal
* Nested loops are key for patterns
* `break` and `continue` control loop execution

Loops are the **backbone of logic building and DSA**.
...
The following problems are carefully selected to **reinforce the concepts** covered in:
- `1.cpp_basics.md`
- `2.operators_and_loops.md`

They help in strengthening **syntax, logic building, and flow control**.

---

### 🔹 Introduction to C++

1. **Print GeeksforGeeks**  
   [Solve Problem](https://www.geeksforgeeks.org/batch/skill-up-cpp/track/su-cpp-day1/problem/print-geeksforgeeks--103724)
...
2. **The Size of Operator**  
   [Solve Problem](https://www.geeksforgeeks.org/batch/skill-up-cpp/track/su-cpp-day2/problem/the-size-of-operator--141631)

3. **Data Types**  
   [Solve Problem](https://www.geeksforgeeks.org/batch/skill-up-cpp/track/su-cpp-day2/problem/data-types--113418)

4. **Typecast and Double It**  
   [Solve Problem](https://www.geeksforgeeks.org/batch/skill-up-cpp/track/su-cpp-day2/problem/typecast-and-double-it--153103)

---

### 🔹 Input / Output

5. **Bitwise Operators (I/O Based)**  
   [Solve Problem](https://www.geeksforgeeks.org/batch/skill-up-cpp/track/su-cpp-day3/problem/bitwise-operators-1597314674--105432)
...
6. **Addition of Two Numbers**  
   [Solve Problem](https://www.geeksforgeeks.org/batch/skill-up-cpp/track/su-cpp-day4/problem/addition-of-two-numbers0812)

7. **Evaluate Formulae**  
   [Solve Problem](https://www.geeksforgeeks.org/batch/skill-up-cpp/track/su-cpp-day4/problem/evaluate-formulae--112853)
...
8. **The if Statement**  
   [Solve Problem](https://www.geeksforgeeks.org/batch/skill-up-cpp/track/su-cpp-day5/problem/the-if-statement--113256)

9. **The else Statement**  
   [Solve Problem](https://www.geeksforgeeks.org/batch/skill-up-cpp/track/su-cpp-day5/problem/the-else-statement--115735)

10. **Switch Statement**  
    [Solve Problem](https://www.geeksforgeeks.org/batch/skill-up-cpp/track/su-cpp-day5/problem/switch-statement--150234)

11. **if-else Decision Making**  
    [Solve Problem](https://www.geeksforgeeks.org/batch/skill-up-cpp/track/su-cpp-day5/problem/c-if-else-decision-making4138)
...
12. **For Loop – Basics**  
    [Solve Problem](https://www.geeksforgeeks.org/batch/skill-up-cpp/track/su-cpp-day6/problem/for-loop-1-1605617969--181812)

13. **Factorial Using Loop**  
    [Solve Problem](https://www.geeksforgeeks.org/batch/skill-up-cpp/track/su-cpp-day6/problem/factorial-1598335080--125944)

14. **While Loop**  
    [Solve Problem](https://www.geeksforgeeks.org/batch/skill-up-cpp/track/su-cpp-day6/problem/while-loop--175711)

15. **Print Square Pattern**  
    [Solve Problem](https://www.geeksforgeeks.org/batch/skill-up-cpp/track/su-cpp-day6/problem/print-square--105330)

16. **Right Angle Triangle Pattern**  
    [Solve Problem](https://www.geeksforgeeks.org/batch/skill-up-cpp/track/su-cpp-day6/problem/right-angle-triangle-2-1605689820--102106)

---

### ⭐ Bonus Problem (Integrated Concepts)

17. **Mixed Concepts Practice (Day 7)**  
    [Solve Problem](https://www.geeksforgeeks.org/batch/skill-up-cpp/track/su-cpp-day7/article/MTM4NDYxMA%3D%3D)
...
- Identify which concept it tests
- Write the solution **from scratch**
- Avoid copying solutions
- Focus on correctness first, optimization later

These problems together form a **strong base for DSA preparation**.

⭐ *Practice consistently — concepts become permanent through application.*
